...
export default function Lobby() {
  ...
  const [currentETHAccount, setCurrentETHAccount] = useContext(
  ...
  const joinGame = async (e, gameId, playerOne) => {
    ...
    if (currentAccount === playerOne) {
      toast.error(
        "You cannot play with yourself... No that's not a challenge",
        {
          position: toast.POSITION.TOP_CENTER,
          autoClose: 2000,
        }
                ...
                <div key={game.gameId}>
                  ...
                  {game.currentPlayers !== game.maxPlayers && (
                    <Button
                      ...
                      className="w-100 text-center mt-2 lobbyBtn lobbyJoinGameBtn"
                      type="submit"
                    >
                      Join Game
                    </Button>
                  ...
                  <Button
                    ...
                    className="w-100 text-center mt-2 lobbyBtn lobbyViewGameBtn"
                    type="submit"
                  >
                    View Game
                  </Button>
