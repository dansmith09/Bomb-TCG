...
export default function Settings() {
  ...
  const toggleMobileMode = () => {
    ...
    alert(`Mobile mode is now ${mobileMode ? "on!" : "off!"}`);
  };
  ...
  return (
    <>
      ...
      >
        <IoIosSettings className="settingsIcon" />
        {menuOpened ? (
          <div className="settingsMenu">
            <div onClick={menuMyAccountOrSignIn}>
              {currentETHAccount ? "My Account" : "Sign In"}
            </div>
            <div // Link to yt tutorial
            >
              How to play
            </div>
            <div
